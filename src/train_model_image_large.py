...
from setup_exp import setup_train_model_image_large
...
parser.add_argument("--dataset", default="celeba_eyeglasses", type=str,
                    help="set the dataset used: celeba_${attribute_name}")
parser.add_argument("--arch", default="alexnet", type=str,
                    help="the network architecture: alexnet")
...
setup_train_model_image_large(args)
