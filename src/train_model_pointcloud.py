...
from setup_exp import setup_train_model_pointcloud
...
parser.add_argument("--dataset", default="shapenet", type=str,
                    help="set the dataset used: shapenet")
parser.add_argument("--arch", default="pointnet", type=str,
                    help="the network architecture: pointnet")
...
parser.add_argument("--logspace", default=None, type=int,
...
setup_train_model_pointcloud(args)
